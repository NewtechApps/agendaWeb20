                ...
                <div class="row pb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            {!! Form::date("dataFinal", request('dataFinal') ?? now()->endOfMonth()->endOfWeek(Carbon\Carbon::FRIDAY) ,["class"=>"form-control", "onkeydown"=>"javascript:if(event.keyCode==13){ $('#search').click(); };" ]) !!}
